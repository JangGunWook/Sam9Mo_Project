...
var Color = class {
  ...
  static fromString(s3) {
    return new Color(string2hex(s3));
  }
  static fromCSS(s3) {
    return new Color(rgba2hex(s3));
  }
  static fromAny(s3) {
    if (isString(s3)) {
      if (s3[0] == "#") {
        return Color.fromString(s3);
      } else if (s3.substr(0, 3) == "rgb") {
        return Color.fromCSS(s3);
      }
    } else if (isNumber(s3)) {
      return Color.fromHex(s3);
    } else if (s3 instanceof Color) {
      return Color.fromHex(s3.hex);
    }
...
var SpriteEventDispatcher = class extends EventDispatcher {
  constructor(sprite) {
    super();
...
var Sprite = class extends Entity {
  ...
  dragMove(e) {
    ...
    if (dragEvent) {
      ...
      let x2 = e.point.x - dragEvent.point.x;
      let y2 = e.point.y - dragEvent.point.y;
      const events = this.events;
...
var Container = class extends Sprite {
  constructor() {
    super(...arguments);
    Object.defineProperty(this, "_display", {
      enumerable: true,
        ...
        if (points) {
          ...
          if (cl > pl) {
            ...
            for (let i = 0; i < pl; i++) {
              ...
              newCopy[i] = { x: copy4[index].x, y: copy4[index].y };
            }
            copy4 = newCopy;
          }
          this.setPrivateRaw("previousPoints", prevCopy);
          this.setPrivateRaw("points", copy4);
...
//# sourceMappingURL=chunk-NMWN7OHN.js.map

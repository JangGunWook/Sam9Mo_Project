...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
def month_save():
    print("매월 1일 월봉데이터를 저장합니다!")
    KOSPI_STOCK_CODE =['005930', '373220', '000660', '207940', '005935', '005490', '005380', '051910', '000270', '035420', '006400', '068270', '003670', '028260', '035720', '105560', '012330', '055550', '066570', '096770', '032830', '003550', '323410', '086790', '033780', '034730', '000810', '138040', '015760', '017670', '018260', '011200', '329180', '047050', '010130', '009150', '259960', '316140', '034020', '024110']
    KOSDAQ_STOCK_CODE = ['247540', '086520', '091990', '022100', '066970', '028300', '196170', '068760', '035900', '277810', '403870', '058470', '263750', '214150', '293490', '041510', '357780', '039030', '145020', '005290', '095340', '112040', '240810', '000250', '253450', '036930', '086900', '035760', '214370', '121600', '067310', '393890', '025900', '034230', '237690', '078600', '048410', '141080', '365340', '195940']
    ...
    def get_first_day_of_previous_month():
        ...
        first_day_of_current_month = today.replace(day=1)  # 이번 달의 1일로 설정

        # 이번 달의 1일에서 하루를 빼서 지난 달의 마지막 날을 구함
        last_day_of_previous_month = first_day_of_current_month - timedelta(days=1)

        # 지난 달의 1일을 구하기 위해 지난 달의 마지막 날에서 날짜를 가져옴
        first_day_of_previous_month = last_day_of_previous_month.replace(day=1)
        return first_day_of_previous_month.strftime("%Y%m%d")

    last_month_firstday = get_first_day_of_previous_month()
    ...
    # kospi 종목 40 주봉데이터 매월 1일에 저장
    if datetime.today().day == 1:
        for code in KOSPI_STOCK_CODE:
            time.sleep(0.5)
            collection = db["kospi_month_stock"]
            data={
                "_id" : code
            }
            try:
            ...
            try : 
                stock= get_domestic_stock_price(code, last_month_firstday,yesterday)["output2"]
                # 배열의 맨위에 추가된다!
                collection.update_one(
                    {"_id" : code},
                    {"$push": {"stock_data": {"$each": stock, "$position": 0}}}
                )
            except Exception as e:
                stock= get_domestic_stock_price(code, last_month_firstday,yesterday)["output2"]
                # 배열의 맨위에 추가된다!
                collection.update_one(
                    {"_id" : code},
                    {"$push": {"stock_data": {"$each": None, "$position": 0}}}
                )

        
    # kosdaq 종목 40 주봉데이터 매월 1일에 저장
    if datetime.today().day == 1:
        for code in KOSDAQ_STOCK_CODE:
            time.sleep(0.5)
            collection = db["kosdaq_month_stock"]
            data={
                "_id" : code
            }
            try:
